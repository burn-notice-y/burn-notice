        ...
        const navItems = (
            <div className={"nav-items-test"}>
                ...
                <List>
                    ...
                    {[['Vacancies', '/vacancy/show'], ['Create Vacancy', `/vacancy/create`], ['Review Requests', '/transfer/view'], [`Assignment History`, `/assignments/show`], ['Station List', '/stations/all']].map((text, index) => (

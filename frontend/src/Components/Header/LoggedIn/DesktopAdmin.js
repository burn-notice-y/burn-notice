...
const DesktopAdmin = (props) => {
    ...
    return (
        <div className={"desktop admin-menu"}>
            <CssBaseline />
            ...
            >
                ...
                <List>
                    <AdminActions closeMenu={props.closeMenu} user={props.user}/>
...
export default withStyles(styles)(DesktopAdmin);